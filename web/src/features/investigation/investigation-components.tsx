...
export function InitialHypotheses({ initial_hypotheses: hypotheses }: Pick<FrozenDashboard, "initial_hypotheses">) {
...
export function EvidenceBoard({ evidence, hypothesis_matrix: matrix }: Pick<FrozenDashboard, "evidence" | "hypothesis_matrix">) {
...
export function HypothesisMatrix({ initial_hypotheses: hypotheses, hypothesis_matrix: matrix, confidence_update: updates }: Pick<FrozenDashboard, "initial_hypotheses" | "hypothesis_matrix" | "confidence_update">) {
