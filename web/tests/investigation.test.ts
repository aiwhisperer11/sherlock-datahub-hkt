...
const investigation = {
  ...
  derived_by_sherlock: [], limitations: ["No logs"], provider_attempts: [{ provider: "snapshot", status: "succeeded", duration_ms: 0 }], selected_provider: "snapshot", conclusion: "Provisional", recommended_action: "Inspect dbt",
