...
This directory indexes cross-cutting material for the monorepo; package
documentation remains with the package that it describes.
...
- [Operational and delivery material](../backend/docs/HACKATHON_EXECUTION_PLAN.md), [web delivery notes](../web/docs/HACKATHON_EXECUTION_PLAN.md), and [web deployment notes](../web/docs/DEPLOYMENT.md)
